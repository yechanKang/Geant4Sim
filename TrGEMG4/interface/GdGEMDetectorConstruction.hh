#ifndef GdGEMDetectorConstruction_hh
#define GdGEMDetectorConstruction_hh
...
class GdGEMDetectorConstruction : public G4VUserDetectorConstruction
{
  public :
    // Constructor
    GdGEMDetectorConstruction() ;
    // Destructor
    virtual ~GdGEMDetectorConstruction() ;
